        ...
        <div className="space-y-8">
            ...
            <div className="flex items-start justify-between">
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-muted-foreground ml-2">(4.9/5 từ 127 đánh giá)</span>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="w-16 text-center font-bold text-2xl text-foreground">{quantity}</span>
              <button
          ...
          <Card className="p-6 bg-gradient-to-br from-neutral-50 to-white border-2 border-neutral-200 shadow-xl space-y-3">
            ...
            {fabricPrice > 0 && (
              <div className="flex justify-between text-sm">
                <span className="text-muted-foreground font-medium">Vải nâng cấp</span>
            ...
            {sizePrice > 0 && (
              <div className="flex justify-between text-sm">
                <span className="text-muted-foreground font-medium">Kích cỡ lớn</span>
                <span className="text-primary font-semibold">
          ...
          <div className="grid grid-cols-2 gap-4 pt-6 border-t-2 border-neutral-200">
            ...
            <div className="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-br from-blue-50 to-transparent">
              ...
              <div className="flex-1">
                <p className="text-sm font-semibold text-foreground">Đảm bảo chất lượng</p>
            ...
            <div className="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-br from-purple-50 to-transparent">
              ...
              <div className="flex-1">
                <p className="text-sm font-semibold text-foreground">Hỗ trợ 24/7</p>
            ...
            <div className="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-br from-amber-50 to-transparent">
              ...
              <div className="flex-1">
                <p className="text-sm font-semibold text-foreground">Đánh giá cao</p>
